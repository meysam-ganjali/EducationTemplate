...
!(function (e, t) {
  ...
  !(function (F) {
    ...
    F.valHooks.select.set = function (e, t) {
      return (
        t && !n.useDefault && F(e).data("selected", !0),
    ...
    function $(e, t, i, s) {
      for (
        var n = ["content", "subtext", "tokens"], o = !1, l = 0;
        l < n.length;
        l++
      ) {
        var r = n[l],
        ...
        if (
          ...
          s && (c = d(c)),
          (c = c.toUpperCase()),
          (o = "contains" === i ? 0 <= c.indexOf(t) : c.startsWith(t)))
        )
          break;
      }
      return o;
    ...
    var l = function (t) {
      ...
      _ = { success: !1, major: "3" };
    try {
      (_.full = (F.fn.dropdown.Constructor.VERSION || "")
        .split(" ")[0]
        .split(".")),
        (_.major = _.full[0]),
        (_.success = !0);
    ...
    var q = {
      ...
      N = { MENU: "." + q.MENU };
    "4" === _.major &&
      ((q.DIVIDER = "dropdown-divider"),
      (q.SHOW = "show"),
      (q.BUTTONCLASS = "btn-light"),
      (q.POPOVERHEADER = "popover-header"));
    var A = new RegExp(H + "|" + L),
      ...
      c =
        ...
        function (e, t) {
          var i = this;
          n.useDefault ||
            ((F.valHooks.select.set = n._set), (n.useDefault = !0)),
            (this.$element = F(e)),
        ...
        if (e.is("select")) {
          ...
          if (t) {
            ...
            (n.template = F.extend(
              ...
              c.DEFAULTS.template,
              F.fn.selectpicker.defaults
                ? F.fn.selectpicker.defaults.template
                : {},
              e.data().template,
              i.template
            )),
              e.data("selectpicker", (t = new c(this, n)));
          }
          "string" == typeof r &&
            (o = t[r] instanceof Function ? t[r].apply(t, l) : t.options[r]);
        }
      });
      return void 0 !== o ? o : t;
    }
    (c.VERSION = "1.13.2"),
      ...
      "4" === _.major &&
        ((c.DEFAULTS.style = "btn-light"),
        (c.DEFAULTS.iconBase = ""),
        (c.DEFAULTS.tickIcon = "bs-ok-default")),
      (c.prototype = {
        constructor: c,
        init: function () {
          var i = this,
            ...
            s = this.options.liveSearch
              ? '<div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off"' +
                (null === this.options.liveSearchPlaceholder
                  ? ""
                  : ' placeholder="' +
                    G(this.options.liveSearchPlaceholder) +
                    '"') +
        ...
        createView: function (C, e) {
          ...
          function i(e, t) {
            ...
            if (
              ...
              (r =
                l[0] !== O.selectpicker.view.position0 ||
                l[1] !== O.selectpicker.view.position1),
              ...
              (t || r) &&
                ((c = O.selectpicker.view.visibleElements
                  ? O.selectpicker.view.visibleElements.slice()
                  : []),
                (O.selectpicker.view.visibleElements = O.selectpicker.current.elements.slice(
                  O.selectpicker.view.position0,
                  O.selectpicker.view.position1
                )),
                O.setOptionStatus(),
              ...
              !0 === m &&
                ...
                (w =
                  O.selectpicker.view.position1 > h - 1
                    ? 0
                    : O.selectpicker.current.data[h - 1].position -
                      O.selectpicker.current.data[
            ...
            if (((O.prevActiveIndex = O.activeIndex), O.options.liveSearch)) {
              if (C && t) {
                var S,
                  y = 0;
                O.selectpicker.view.canHighlight[y] ||
                  (y =
        ...
        createLi: function () {
          ...
          (e.className =
            T.options.iconBase + " " + T.options.tickIcon + " check-mark"),
            W.a.appendChild(e),
              ...
              return (
                e &&
                  (1 === e.nodeType || 11 === e.nodeType
                    ? n.appendChild(e)
                    : (n.innerHTML = e)),
                void 0 !== i && "" !== i && (n.className = i),
                null != s && n.classList.add("optgroup-" + s),
                n
              );
            },
            U = function (e, t, i) {
              ...
              if (e.optionContent) s.innerHTML = e.optionContent;
                ...
                if (((s.textContent = e.text), e.optionIcon)) {
                  ...
                  ((i = W.span.cloneNode(!1)).className =
                    T.options.iconBase + " " + e.optionIcon),
                    B.appendChild(i),
                    B.appendChild(n);
                }
                e.optionSubtext &&
                  (((t = W.subtext.cloneNode(!1)).innerHTML = e.optionSubtext),
                  s.appendChild(t));
              }
          ...
          if (this.options.title && !this.multiple) {
            ...
            if (s)
              (this.selectpicker.view.titleOption.className =
                ...
                (i =
                  void 0 === F(t.options[t.selectedIndex]).attr("selected") &&
            ...
            if ((R++, !t.hasClass("bs-title-option"))) {
              ...
              if (
                ...
                (i = n.prevHiddenIndex),
                  ...
                  g ||
                    (void 0 !== i &&
                      (y = j[i].previousElementSibling) &&
                      "OPTGROUP" === y.tagName &&
                      !y.disabled &&
                      (g = !0)),
                  g &&
                    "divider" !== N[N.length - 1].type &&
                    (R++,
                    D.push(M(!1, 0, q.DIVIDER, A + "div")),
                    N.push({ type: "divider", optID: A }));
              } else {
                if (f && !0 !== n.divider) {
                  ...
                  if (!this.previousElementSibling) {
                    ...
                    var S = (function (e) {
                      ...
                      if (((s.innerHTML = e.labelEscaped), e.labelIcon)) {
                        var n = W.whitespace.cloneNode(!1);
                        ((i = W.span.cloneNode(!1)).className =
                          T.options.iconBase + " " + e.labelIcon),
                          B.appendChild(i),
                          B.appendChild(n);
                      }
                      return (
                    ...
                    D.push(M(S, 0, "dropdown-header" + x, A)),
                      N.push({
                        content: k,
                        subtext: $,
                        type: "optgroup-label",
                  ...
                  D.push(M(!1, 0, q.DIVIDER)),
                    N.push({ type: "divider", originalIndex: e, data: n });
                else {
                  var y;
        ...
        render: function () {
          ...
          for (
            var n = 0, o = this.selectpicker.main.elements.length;
            n < o;
            n++
          ) {
            ...
            if (
              ...
              l.selected &&
              (i.push(l),
              (s.length < 100 && "count" !== e.options.selectedTextFormat) ||
                1 === i.length)
            ) {
              if (
              ...
              var r,
                ...
                d =
                  a.icon && e.options.showIcon
                    ...
                    : "";
              (r =
                e.options.showSubtext && a.subtext && !e.multiple
                  ? ' <small class="text-muted">' + a.subtext + "</small>"
                  : ""),
                (c = l.title
                  ? l.title
                  : a.content && e.options.showContent
                  ? a.content.toString()
          ...
          if (
            ...
            if (
              (1 < p.length && i.length > p[1]) ||
              (1 === p.length && 2 <= i.length)
            ) {
              var u = this.selectpicker.view.availableOptionsCount;
              h = ("function" == typeof this.options.countSelectedText
                ? this.options.countSelectedText(i.length, u)
                : this.options.countSelectedText
              )
                .replace("{0}", i.length.toString())
        ...
        liHeight: function (e) {
          if (e || (!1 !== this.options.size && !this.sizeInfo)) {
            ...
            var t = document.createElement("div"),
              ...
              d =
                this.options.header &&
                0 < this.$menu.find("." + q.POPOVERHEADER).length
                  ? this.$menu.find("." + q.POPOVERHEADER)[0].cloneNode(!0)
                  : null,
            ...
            var m,
              ...
              y = {
                vert:
                  O($ ? $.paddingTop : S.css("paddingTop")) +
                  O($ ? $.paddingBottom : S.css("paddingBottom")) +
                  O($ ? $.borderTopWidth : S.css("borderTopWidth")) +
                  O($ ? $.borderBottomWidth : S.css("borderBottomWidth")),
                horiz:
                  O($ ? $.paddingLeft : S.css("paddingLeft")) +
                  O($ ? $.paddingRight : S.css("paddingRight")) +
                  O($ ? $.borderLeftWidth : S.css("borderLeftWidth")) +
                  O($ ? $.borderRightWidth : S.css("borderRightWidth")),
              },
              C = {
                vert:
                  y.vert +
                  O($ ? $.marginTop : S.css("marginTop")) +
                  O($ ? $.marginBottom : S.css("marginBottom")) +
                  2,
                horiz:
                  y.horiz +
                  O($ ? $.marginLeft : S.css("marginLeft")) +
                  O($ ? $.marginRight : S.css("marginRight")) +
                  2,
              };
        ...
        setMenuSize: function (e) {
          ...
          if (
            ...
            (t = (i = a * this.options.size + v * f + m.vert) - m.vert),
              (o = i + d + h + p + u),
              (s = l = "");
          }
          "auto" === this.options.dropdownAlignRight &&
            this.$menu.toggleClass(
              ...
              this.sizeInfo.selectOffsetLeft >
                this.sizeInfo.selectOffsetRight &&
                this.sizeInfo.selectOffsetRight < this.$menu[0].offsetWidth - c
            ),
            this.$menu.css({
              "max-height": o + "px",
              overflow: "hidden",
          ...
          var s,
            ...
            e = function (e) {
              var t = {},
                i =
                  l.options.display ||
                  F.fn.dropdown.Constructor.Default.display;
              l.$bsContainer
                .addClass(
          ...
          this.$button.on("click.bs.dropdown.data-api", function () {
            l.isDisabled() ||
              ...
              l.$bsContainer
                ...
                .toggleClass(q.SHOW, !l.$button.hasClass(q.SHOW))
                .append(l.$menu));
          }),
        ...
        setSelected: function (e, t, i, s) {
          ...
          i || (i = this.selectpicker.main.map.newIndex[e]),
            ...
            l &&
              ...
              l.classList.toggle("active", c),
              l.setAttribute("aria-selected", t)),
            c ||
              (!r &&
                t &&
                void 0 !== this.prevActiveIndex &&
                ((n = this.selectpicker.main.map.newIndex[
                  this.prevActiveIndex
                ]),
                (o = this.selectpicker.main.elements[n]).classList.toggle(
                  "selected",
                  t
                ),
                o.classList.remove("active"),
                o.firstChild &&
                  (o.firstChild.classList.toggle("selected", t),
        ...
        setDisabled: function (e, t, i, s) {
          ...
          i || (i = this.selectpicker.main.map.newIndex[e]),
            ...
            n &&
              ("4" === _.major && n.classList.toggle(q.DISABLED, t),
              n.setAttribute("aria-disabled", t),
              t
            ...
            this.$menuInner.on("click", "li a", function (e, t) {
              ...
              if (
                (E.multiple &&
                  ...
                  e.stopPropagation(),
                e.preventDefault(),
                !E.isDisabled() && !i.parent().hasClass(q.DISABLED))
              ) {
                  ...
                  if (
                    ...
                    if ((u && m) || (f && v))
                      if (u && 1 == u) {
                        ...
                        x[2] &&
                          ((I = I.replace("{var}", x[2][1 < u ? 0 : 1])),
                          (k = k.replace("{var}", x[2][1 < f ? 0 : 1]))),
                          a.prop("selected", !1),
                          E.$menu.append($),
                          u &&
                            m &&
                ...
                !E.multiple || (E.multiple && 1 === E.options.maxOptions)
                  ? E.$button.focus()
                  : E.options.liveSearch && E.$searchbox.focus(),
                  r &&
                    ((o != S(E.$element[0]) && E.multiple) ||
                      (l != E.$element.prop("selectedIndex") && !E.multiple)) &&
                    ((y = [n, a.prop("selected"), o]),
            ...
            this.$menu.on(
              ...
              function (e) {
                e.currentTarget == this &&
                  (e.preventDefault(),
                  e.stopPropagation(),
                  E.options.liveSearch && !F(e.target).hasClass("close")
                    ? E.$searchbox.focus()
                    : E.$button.focus());
              }
            ),
              ...
              if (
                ...
                for (var r = 0; r < u.selectpicker.main.data.length; r++) {
                  ...
                  s[r] || (s[r] = $(c, i, o, l)),
                    s[r] &&
                      ...
                      (0 < c.headerIndex &&
                        ((s[c.headerIndex - 1] = !0),
                        n.push(c.headerIndex - 1)),
                      (s[c.headerIndex] = !0),
                      n.push(c.headerIndex),
                      (s[c.lastIndex + 1] = !0)),
                ...
                for (var a = n.length; r < a; r++) {
                  ...
                  ("divider" !== c.type ||
                    ...
                    c.hasOwnProperty("originalIndex") &&
                      ((u.selectpicker.search.map.newIndex[c.originalIndex] =
                        t.length - 1),
          ...
          if (this.multiple) {
            ...
            for (
              ...
              r &&
                !r.disabled &&
                "divider" !== l.type &&
                (r.selected && i++, (r.selected = e), r.selected && s++);
            }
            this.$element.removeClass("bs-select-hidden"),
              i !== s &&
        ...
        keydown: function (e) {
          ...
          if (
            (!(i = c.$newElement.hasClass(q.SHOW)) &&
              (p ||
            ...
            e.which === C &&
              i &&
              (e.preventDefault(),
              c.$button.trigger("click.bs.dropdown.data-api").focus()),
            p)
          ) {
            if (!a.length) return;
            void 0 ===
              (t =
                !0 === f
                  ? a.index(a.filter(".active"))
                  : c.selectpicker.current.map.newIndex[c.activeIndex]) &&
              (t = -1),
              -1 !== t &&
                ((s = c.selectpicker.current.elements[t + m]).classList.remove(
                  "active"
                ),
              ...
              e.which === H
                ? (-1 !== t && t--,
                  t + m < 0 && (t += a.length),
                  c.selectpicker.view.canHighlight[t + m] ||
                    (-1 ===
                      (t =
                      ...
                      (t = a.length - 1)))
                : (e.which === L || h) &&
                  (++t + m >= c.selectpicker.view.canHighlight.length &&
                    (t = 0),
                  c.selectpicker.view.canHighlight[t + m] ||
                    (t =
                      t +
            ...
            e.which === H
              ? 0 === m && t === a.length - 1
                ...
                : (d =
                    (o =
                      (n = c.selectpicker.current.data[v]).position -
                      n.height) < u)
              : (e.which === L || h) &&
                (0 === t
              ...
              (s = c.selectpicker.current.elements[v]) &&
                (s.classList.add("active"),
                s.firstChild && s.firstChild.classList.add("active")),
            ...
            (!l.is("input") && !P.test(e.which)) ||
            (e.which === T && c.selectpicker.keydown.keyHistory)
          ) {
            var g,
              b,
              w = [];
            ...
            for (var x = 0; x < c.selectpicker.current.data.length; x++) {
              ...
              $(I, b, "startsWith", !0) &&
                ...
                ((I.index = x), w.push(I.originalIndex));
            }
            if (w.length) {
              var k = 0;
              a.removeClass("active").find("a").removeClass("active"),
                1 === b.length &&
                  (-1 === (k = w.indexOf(c.activeIndex)) || k === w.length - 1
                    ? (k = 0)
                    : k++),
                (g = c.selectpicker.current.map.newIndex[w[k]]),
                0 < u - (n = c.selectpicker.current.data[g]).position
                  ? ((o = n.position - n.height), (d = !0))
                  : ((o = n.position - c.sizeInfo.menuInnerHeight),
                    (d = n.position > u + c.sizeInfo.menuInnerHeight)),
                (s = c.selectpicker.current.elements[g]).classList.add(
                  "active"
                ),
                s.firstChild && s.firstChild.classList.add("active"),
                (c.activeIndex = w[k]),
          ...
          i &&
            ((e.which === T && !c.selectpicker.keydown.keyHistory) ||
              e.which === z ||
              (e.which === D && c.options.selectOnTab)) &&
            (e.which !== T && e.preventDefault(),
            (c.options.liveSearch && e.which === T) ||
              (c.$menuInner.find(".active a").trigger("click", !0),
              l.focus(),
              c.options.liveSearch ||
                (e.preventDefault(), F(document).data("spaceSelect", !0))));
        },
        mobile: function () {
